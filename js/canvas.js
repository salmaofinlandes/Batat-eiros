...
function updateLegenda(n){
  ...
  else if(n==7){legenda.innerHTML ="<p><b>7.Biela -</b> Haste que liga o pistão à cambota.</p>"}
  else if(n==6){legenda.innerHTML ="<p><b>6.Pistão -</b> É uma peça cilíndrica fechada na parte de cima e aberta na parte de baixo. É uma das principais peças do motor de um carro, com a função de comprimir a mistura de ar/combustível para ser queimada na combustão e fazer rodar a cambota.</p>"}
